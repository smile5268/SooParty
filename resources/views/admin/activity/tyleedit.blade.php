...
<form action="{{URL('admin\activity\editten')}}" method="POST" >
<input type="hidden" name="_token" value="{{ csrf_token() }}">
 <input type="hidden" name="id" value="{{$users->id}}">
 
 <table>
    <tr>
    	<td class="class_a">名称：</td>
    	<td class="class_b"><input class="input" type="text" name="push" value="{{$users->push}}"></td>
    </tr>
    <tr>
