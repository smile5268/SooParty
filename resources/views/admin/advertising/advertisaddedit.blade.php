...
<form action="{{URL('admin\advertising\advertisadded')}}" method="POST" enctype="multipart/form-data">
<input type="hidden" name="_token" value="{{ csrf_token() }}">
 <input type="hidden" name="id" value="{{$use->id}}">
 <table>
    <tr>
        <td class="class_a">链接：</td>
        <td class="class_b"><input type="text" name="link" value="{{$use->site}}"></td>
    </tr>
    <tr>
        <td class="class_a">原图：</td>
        <td class="class_b"><img src="{{$use->photo}}" alt="" style="width:500px;height:250px;"></td>
    </tr>
    <tr>
