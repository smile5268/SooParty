...
<div class="Tab">
  <table border="1" cellpadding="0" cellspacing="0" >
    ...
    <tr >
        <td>{{$val->id}}</td>
        <td><img src="{{$val->photo}}" alt="" style="width:200px;height:60px;"></td>
      
    
        <td class="tu">
        <a href="{{URL('admin/advertising/edit')}}?id={{$val->id}}">换图</a>
        |
        <a href="{{URL('admin/advertising/del')}}?id={{$val->id}}">删除</a>
        </td>
     </tr>
   @endforeach
  </table>
