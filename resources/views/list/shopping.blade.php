...
<div class="catbox">
    <table id="cartTable">
        ...
        <tr >
            ...
            <td class="goods">
              <a href="{{ URL('list/details') }}?id={{ $det->act_id }}">
                <span><img src="../images/ly.jpg" alt="" style="width:120px;height:96px;"/></span>
                <div>
            ...
            <td class="price">0.00</td>
             ...
             @endif
                ...
                <span class="add" id="{{ $det->act_id }}">+</span>
            </td>
    ...
    <div class="cartFoot" id="cartFoot">
      ...
      <!--   <a class="fl delete" id="deleteAll" href="javascript:;">删除</a> -->
        <div class="fr closing" onclick="addOrder();">提交订单</div>
...
<form class="form-send" name="form-send" action="{{ URL('list/order') }}" method="POST">
    <input type='hidden' name="_token" value="{{ csrf_token() }}">
    <input class="form-num" type="hidden" name="shoppingId" value="">
</form>
<script>
    // 付款
    function addOrder(){
        ...
        // 勾选可以提交，没有勾选不可以提交
        if(chk_value != ''){
            var att= $('.form-num').attr("value",chk_value);
            $('.form-send').submit(); // 提交form 
        }
                    ...
                    $.ajax({ 
                       ...
                       data:{'actId':actId,'_token':"{{ csrf_token() }}",'packs':packs},
                        ...
                        if(data){
                             ...
                             window.location='http://'+host+"/list/shoppingCart";
                            // return false  ;
                        }
