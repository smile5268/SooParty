...
<script src="{{ URL('js/add.js') }}"></script>
	...
	<div class="acti-shop" >
		<div class="acti-shop-l">
           ...
           <!-- <div class="join-num" > -->
              <div class="acti-join"  > 已参与：{{$num}}
                <div class="join-people">
                <p class="join-man">♂：{{$nan}}</p>
                <p class="join-women" >♀：{{$nv}}</p>
              </div> 
             </div>  
             <!-- <div class="people-limit">
             	人数上限：$details->activity_number}}
             </div> -->
		...
		<div class="acti-shop-r">
			...
			<div class="acti-shop-num">
				...
				<div class="acti-shop-vote">
				    @if($full==2)		
                        <a  class="acti-shop-payy payy-no" >立即付款</a>
                    @elseif($full==1) 
					...
					<script>
						...
						window._bd_share_config = {
							common : {
								...
								bdUrl:site,
								bdPic:"http://www.sooparty.com/images/sooparty.jpg",			
							},
							share : [
								{
									'tag':'share_1',
...
function shooping(){
	...
	$.ajax({
		...
		"success":function(data){
		     ...
		     // var datval1=data.attend
               // swal("Good!",datval,"success");
			swal(datval);
			// else{
			// 	 swal("Sorry!",datval1,"error");
			// }
